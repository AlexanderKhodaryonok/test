...
export const filterSelector = createSelector(stocksPageSelector,
                                             stockPage => stockPage.filter || '');

export const isShowMyStocksSelector = createSelector(stocksPageSelector,
                                                     stockPage => stockPage.isShowMyStocks);
...
export const currentStockIdSelector = createSelector(stocksPageSelector,
                                                     stocksPage => stocksPage.currentStockId || '',
);

export const stockByIdSelector = createSelector(
  [stocksSelector, currentStockIdSelector],
  (stocks: [], currentStockId: string) => stocks && stocks.find(
    (stock: IStock) => stock.id === currentStockId),
);
